...
define([
    ...
    describe('continuation builder', function () {
        ...
        it('basic with $DO', function (done) {
            var x = 0;
        ...
        it('basic without $DO', function (done) {
            var x = 0;
        ...
        it('calling without `continuation`', function (done) {
            var x = 0;
        ...
        it('`this` is maintained throught the chain of `$DO`-s.', function (done) {
            function f(timeout, continuation) {
                setTimeout(function () {
                    this.x += 1;
                    continuation();
        ...
        it('onError is called', function (done) {
            function f(timeout) {
